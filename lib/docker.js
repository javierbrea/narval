...
const writeCloseLog = function (service, suite, type, code) {
  const fileFolder = paths.cwd.resolve('.narval', 'logs', type, suite, service, 'exit-code.log')
